...
library(ggplot2)
library(dplyr) 
customer_churn <- read.csv("C:\\Users\\preem\\Desktop\\DS\\RStudio\\Data\\CSV\\customer_churn.csv")

plot(customer_churn$Dependents)
plot(customer_churn$Dependents, col="coral")
plot(customer_churn$Dependents, col="coral",xlab="Dependents",ylab="Frequency")
#------
